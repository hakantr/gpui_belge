...
- Sağ tarafta platform pencere butonlarının bulunabileceği akılda tutulmalıdır. Ürün butonlarının sağ iç boşluğu ve flex daralma davranışı bu olasılığa göre test edilir. Bu test yoksa pencere butonlarıyla çakışma yaşanabilir.
