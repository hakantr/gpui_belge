...
- Titlebar üzerindeki interaktif child'lar sürükleme propagation'ı ile çakışıyor mu test edilir; bir buton tıklamasının pencereyi sürüklemediğinden emin olunur.
...
- Runtime'da titlebar yüksekliği, banner veya yoğunluk değişiyorsa `window.set_traffic_light_position(...)` ile native buton konumu da güncelleniyor mu kontrol edilir.
