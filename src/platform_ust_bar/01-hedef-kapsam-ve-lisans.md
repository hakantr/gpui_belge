...
> **Tema rehberi ilgili bölüm ile fark:** Tema sözleşmesi alan adlarını mirror eder; yani veri şekli aynı tutulur. Burada ise **davranış** mirror edilir. "Fareye basıldığında pencere sürüklenmeye başlar" veya "kapat butonu ana caption'ın sağ ucunda durur" gibi gözlemlenebilir davranışlar telif kapsamında olmadığı için yeniden inşa edilebilir.
