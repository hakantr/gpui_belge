...
| Grup | API | Not |
|---|---|---|
| Trait metotları | `visibility` | Trait sözleşmesinin implementor tarafından sağlanan public metotlarıdır. |

### `ScrollbarAutoHide`

| Grup | API | Not |
|---|---|---|
| Metotlar | `should_hide` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |
...
| Grup | API | Not |
|---|---|---|
| Trait assoc type | `Output` | Trait sözleşmesinin public ilişkili tipleridir. |
| Trait metotları | `custom_scrollbars`, `vertical_scrollbar_for` | Trait sözleşmesinin implementor tarafından sağlanan public metotlarıdır. |

### `ScrollAxes`

| Grup | API | Not |
|---|---|---|
| Varyantlar | `Both`, `Horizontal`, `Vertical` | Public enum sözleşmesinin varyantlarıdır; davranış bu dosyadaki konu bağlamıyla okunur. |

### `Scrollbars`

| Grup | API | Not |
|---|---|---|
| Metotlar 1 | `always_visible`, `for_settings`, `id`, `new`, `notify_content`, `show_along`, `style`, `tracked_entity` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |
| Metotlar 2 | `tracked_scroll_handle`, `with_stable_track_along`, `with_track_along` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |

### `ScrollableHandle`

| Grup | API | Not |
|---|---|---|
| Trait metotları | `content_size`, `drag_ended`, `drag_started`, `max_offset`, `offset`, `scrollable_along`, `set_offset`, `viewport` | Trait sözleşmesinin implementor tarafından sağlanan public metotlarıdır. |
