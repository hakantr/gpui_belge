...
| Grup | API | Not |
|---|---|---|
| Metotlar | `component_map`, `components`, `get`, `len`, `previews`, `sorted_components`, `sorted_previews` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |
...
| Grup | API | Not |
|---|---|---|
| Metotlar | `description`, `id`, `name`, `preview`, `scope`, `scopeless_name`, `sort_name`, `status` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |

### `PreviewPage`

| Grup | API | Not |
|---|---|---|
| Varyantlar | `AllComponents`, `Component` | Public enum sözleşmesinin varyantlarıdır; davranış bu dosyadaki konu bağlamıyla okunur. |

### `ComponentPreview`

| Grup | API | Not |
|---|---|---|
| Metotlar | `active_page_id`, `new` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |
