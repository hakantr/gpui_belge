...
- `../zed/crates/component/src/component.rs`, registry global'ini `COMPONENT_DATA: LazyLock<RwLock<ComponentRegistry>>` olarak tutar. Tüketici kod doğrudan bu global'e gitmez; bunun yerine `components()`, `register_component::<T>()` ve `ComponentRegistry` accessor'ları kullanılır.
