...
- Aynı dosya, active page bilgisini `ComponentPreviewDb` üzerinden `component_previews` tablosunda saklar. Preview item split veya restore sırasında `SerializableItem` implementasyonu bu durumu geri yükler.
