...
Crate `Rgba` parse'ı için ayrıca renk yardımcıları içerir; import modülü VS Code tema ve renk ayarlarını Zed `Hsla`/`Rgba` modeline çevirirken bu okuyucuları kullanır.
