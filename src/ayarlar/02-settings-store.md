...
| `SandboxPermissionsContent` | Agent terminal sandbox izinleri | "Allow always" seçimiyle kalıcı hale gelen ağ, yazma yolu ve sandbox dışı çalışma izinlerini taşır. |
...
| Grup | API | Not |
|---|---|---|
| Metotlar 1 | `add_favorite_model`, `add_tool_allow_pattern`, `add_tool_deny_pattern`, `allow_sandbox_fs_write_all`, `allow_sandbox_network`, `allow_sandbox_unsandboxed`, `remove_favorite_model`, `set_dock` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |
| Metotlar 2 | `set_flexible_size`, `set_inline_assistant_model`, `set_model`, `set_profile`, `set_sidebar_side`, `set_tool_default_permission`, `update_favorite_model` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |
| Metotlar 3 | `add_sandbox_write_path` | Agent terminal sandbox yazma izni listesine mutlak path alt ağacı ekler; daha genel bir path eklendiğinde onun altındaki dar izinleri budar. |
...
| Alanlar 5 | `sandbox_permissions`, `tool_permissions`, `use_modifier_to_send` | Public veri sözleşmesinin alanlarıdır; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
...
| Grup | API | Not |
|---|---|---|
| Alanlar | `api_url`, `available_models`, `custom_headers` | Public veri sözleşmesinin alanlarıdır; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
...
| Grup | API | Not |
|---|---|---|
| Alanlar | `allow_global`, `authentication_method`, `available_models`, `custom_headers`, `endpoint_url`, `guardrail_identifier`, `guardrail_version`, `profile`, `region` | Public veri sözleşmesinin alanlarıdır; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
...
| Grup | API | Not |
|---|---|---|
| Alanlar | `api_url`, `auto_discover`, `available_models`, `context_window`, `custom_headers` | Public veri sözleşmesinin alanlarıdır; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
...
| Grup | API | Not |
|---|---|---|
| Alanlar | `api_url`, `available_models`, `custom_headers`, `show_free_models`, `show_go_models`, `show_zen_models` | Public veri sözleşmesinin alanlarıdır; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
...
| Grup | API | Not |
|---|---|---|
| Alanlar | `api_key`, `api_url`, `available_models`, `custom_headers` | Public veri sözleşmesinin alanlarıdır; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
