...
| Assoc const | `OPTIONS` | Inherent impl üzerinde public sabit yüzeyidir; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
| Metotlar | `asset_path`, `from_names`, `names` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |
...
| Trait metotları | `into_gpui` | Trait sözleşmesinin implementor tarafından sağlanan public metotlarıdır. |

### `EditableSettingControl`

| Grup | API | Not |
|---|---|---|
| Trait assoc type | `Value` | Trait sözleşmesinin public ilişkili tipleridir. |
| Trait metotları | `apply`, `name`, `read`, `write` | Trait sözleşmesinin implementor tarafından sağlanan public metotlarıdır. |

### `UserSettingsContentExt`

| Grup | API | Not |
|---|---|---|
| Trait metotları | `for_os`, `for_profile`, `for_release_channel` | Trait sözleşmesinin implementor tarafından sağlanan public metotlarıdır. |

### `SettingsAssets`

| Grup | API | Not |
|---|---|---|
| Metotlar | `get`, `iter` | Builder, sorgu veya runtime çağrılarıdır; ayrıntı bu dosyadaki kullanım bağlamıyla okunur. |

### `RegisteredSetting`

| Grup | API | Not |
|---|---|---|
| Alanlar | `from_settings`, `id`, `settings_value` | Public veri sözleşmesinin alanlarıdır; kullanım bağlamı bu dosyadaki ana açıklamayla okunur. |
