...
Okuma akışı kronolojik tutulmuştur: önce import, render modeli ve ortak
veri tipleriyle zemin kurulur; sonra ham GPUI primitive'leri ve layout
yardımcıları gelir. Bu temel üstüne metin/ikon atomları, butonlar, form
kontrolleri ve menü/popup etkileşimleri eklenir. Uzun içerik ve navigasyon
katmanı scrollbar, liste, tree ve tab bileşenleriyle tamamlanır; veri tablosu,
feedback, yardımcı/domain bileşenleri ve entegre örnekler en sona bırakılır.
Böylece her bölüm, önceki bölümde anlatılan kavramların üstüne kurulur.
